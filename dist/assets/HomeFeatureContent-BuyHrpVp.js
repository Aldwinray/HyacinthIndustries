import{m as t,j as e,A as C}from"./motion-Cy3Fut2F.js";import{d as M,r as m}from"./vendor-BQFpGxKL.js";import{d as i,m as S}from"./styled-CFUkIykv.js";import{ai as T}from"./icons-BMgoPnMN.js";import{B as I}from"./index-nbaXq9k7.js";import{b as E}from"./office-Bip-LbGP.js";import{w as H}from"./coding-DYEnY3xo.js";import{H as A}from"./healthcare-C4VecUyJ.js";const B=({image:n,title:a,description:o,tag:l,link:s,icon:g})=>{const v=M(),[y,f]=m.useState(!1),[d,k]=m.useState(()=>window.innerWidth<=768),[b,x]=m.useState(!1),z=p=>/^https?:\/\//i.test(p);m.useEffect(()=>{const p=()=>{const w=window.innerWidth<=768;k(w),w||x(!1)};return window.addEventListener("resize",p),()=>window.removeEventListener("resize",p)},[]);const r=d?b:y,j=()=>{if(!s&&d){x(p=>!p);return}if(s){if(d&&!b){x(!0);return}if(z(s)){window.location.assign(s);return}v(s)}};return e.jsxs(D,{as:t.article,onHoverStart:()=>!d&&f(!0),onHoverEnd:()=>!d&&f(!1),onClick:j,style:{cursor:s||d?"pointer":"default"},initial:!1,animate:{y:r?-4:0},transition:{duration:.28,ease:[.23,1,.32,1]},children:[e.jsx(W,{as:t.div,image:n,animate:{opacity:r?1:0,scale:r?1.03:1},transition:{duration:.4,ease:[.23,1,.32,1]}}),e.jsx(U,{as:t.div,initial:!1,animate:{backgroundColor:r?"rgba(18, 18, 20, 0.2)":"rgba(255, 255, 255, 0.97)",borderColor:r?"rgba(255,255,255,0.14)":"rgba(0,0,0,0.06)"},transition:{duration:r?.35:.28,ease:[.23,1,.32,1]},children:e.jsxs(L,{children:[g&&e.jsx(R,{as:t.div,animate:{backgroundColor:r?"rgba(255,255,255,0.16)":"#f7f7f8",borderColor:r?"rgba(255,255,255,0.14)":"rgba(0,0,0,0.05)"},transition:{duration:.25},children:e.jsx(g,{size:22})}),e.jsxs(V,{children:[e.jsx(F,{as:t.h3,animate:{color:r?"#ffffff":"#23262f"},transition:{duration:.24},children:a}),e.jsx($,{as:t.p,animate:{color:r?"rgba(255,255,255,0.86)":"#667085"},transition:{duration:.24},children:o})]}),e.jsx(P,{children:e.jsx(C,{mode:"wait",children:r?e.jsxs(G,{as:t.div,initial:{opacity:0,y:12},animate:{opacity:1,y:0},exit:{opacity:0,y:8},transition:{duration:.24},children:[e.jsx(O,{children:l}),e.jsx(N,{size:18})]},"cta"):e.jsx(X,{},"spacer")})})]})})]})},D=i.div`
  position: relative;
  width: 100%;
  min-height: 360px;
  height: 100%;
...
`,X=i.div`
  height: 44px;
`,h={smooth:[.23,1,.32,1],snappy:[.16,1,.3,1]},u={hidden:{opacity:0},visible:{opacity:1,transition:{staggerChildren:.1,delayChildren:.08}}},c={hidden:{opacity:0,y:24},visible:{opacity:1,y:0,transition:{duration:.6,ease:h.smooth}}},q={hidden:{opacity:0},visible:{opacity:1,transition:{staggerChildren:.12,delayChildren:.15}}},J={hidden:{opacity:0,y:32,scale:.96},visible:{opacity:1,y:0,scale:1,transition:{duration:.5,ease:h.smooth}}},K=[{id:1,image:E,title:"Professional Outsourcing",description:"Transform your business with our comprehensive outsourcing solutions. From administrative support to specialized medical services, we deliver excellence across industries.",tag:"Learn More"},{id:2,image:H,title:"Digital Solutions",description:"Access world-class web design, development, and creative services. Our team delivers cutting-edge solutions in UI/UX design, digital marketing, 3D animation, and more.",tag:"Explore Services"},{id:3,image:A,title:"Healthcare Solutions",description:"Revolutionize healthcare delivery with our virtual nursing, emergency assistance, and medical support services. Experience healthcare innovation at its best.",tag:"Discover Healthcare"}],fe=m.memo(()=>{const n=typeof window<"u"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,a=o=>n?{hidden:{opacity:1},visible:{opacity:1}}:o;return e.jsxs(Y,{as:t.section,variants:a(u),initial:"hidden",whileInView:"visible",viewport:{once:!0,amount:.2,margin:"-100px"},children:[e.jsx(Z,{}),e.jsx(_,{}),e.jsxs(ee,{children:[e.jsxs(ie,{as:t.div,variants:a(u),children:[e.jsxs(te,{variants:a(c),children:[e.jsx(ae,{}),e.jsx("span",{children:"What We Do"})]}),e.jsx(re,{variants:a(c),children:"Featured Capabilities"}),e.jsx(ne,{variants:a(c),children:"Explore the solutions that help organizations streamline operations, strengthen delivery, and support long-term growth."})]}),e.jsx(oe,{as:t.div,variants:a(q),children:K.map((o,l)=>e.jsx(se,{as:t.div,variants:a(J),custom:l,whileHover:n?{}:{y:-8,transition:{duration:.3,ease:h.smooth}},children:e.jsx(B,{...o})},o.id))})]})]})}),Q=S`
