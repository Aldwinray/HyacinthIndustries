...
const HealthcareContentWrapper = () => {
...
export default HealthcareContentWrapper;
...
// Trends section styled components
...
// Statistics section styled components
...
// Medical Outsourcing section styled components
...
const CTASection = styled.section`
  padding: 5rem 2rem;
  background: linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.8)), url(${HealthcareImg2});
  background-size: cover;
  background-position: center;
